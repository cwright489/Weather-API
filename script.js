...
$.ajax({
    ...
    $(".feelsLike1").text("Feels Like: " + response.list[0].main.feels_like + "F");
    $(".feelsLike2").text("Feels Like: " + response.list[1].main.feels_like + "F");
    $(".feelsLike3").text("Feels Like: " + response.list[2].main.feels_like + "F");
    $(".feelsLike4").text("Feels Like: " + response.list[3].main.feels_like + "F");
    $(".feelsLike5").text("Feels Like: " + response.list[4].main.feels_like + "F");
